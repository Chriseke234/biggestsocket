    ...
    <section className="relative py-24 sm:py-32 bg-[#0B0F14] overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <Link
            href="/gallery"
            className="inline-flex items-center gap-2 rounded-full bg-brand-gold px-6 py-3 text-sm font-bold text-[#0B0F14] shadow-gold hover:scale-105 active:scale-95 transition-all duration-200 shrink-0"
          >
            <span>View Full Portfolio</span>
            <ArrowRight className="h-4 w-4 text-[#0B0F14]" />
          </Link>
        </div>
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {previewItems.map((item, idx) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-3xl cursor-pointer border border-[#1E293B] hover:border-brand-gold/40 shadow-card transition-all duration-300 ${
            ...
            >
              ...
              {/* Overlay */}
              <div className="absolute inset-0 bg-black/60 group-hover:bg-black/75 transition-colors" />
              ...
              <div className="absolute inset-0 z-10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-gold text-[#0B0F14] shadow-gold transform scale-75 group-hover:scale-100 transition-transform">

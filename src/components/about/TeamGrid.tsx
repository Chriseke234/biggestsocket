          ...
          {teamData.map((member, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/* FRONT OF CARD */}
                  <div className="absolute inset-0 h-full w-full rounded-3xl overflow-hidden border border-brand-gold/30 shadow-card bg-brand-blue-deep text-white backface-hidden flex flex-col justify-end p-6">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="mt-2 flex items-center gap-1.5 text-xs text-brand-cream/80">
                  ...
                  <div className="absolute inset-0 h-full w-full rounded-3xl overflow-hidden border-2 border-brand-gold bg-brand-blue-deep p-6 text-white backface-hidden rotate-y-180 shadow-2xl flex flex-col justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-xs font-medium text-brand-gold-light">
                        {member.role}
                      </p>

                      <div className="my-4 h-px w-full bg-brand-gold/30" />

                      <p className="text-xs sm:text-sm leading-relaxed text-brand-cream/90">
                        {member.bio}
                      </p>
                    </div>
                    ...
                    <div className="pt-4 border-t border-brand-gold/20 flex items-center justify-between text-xs text-brand-gold font-semibold">
                      ...
                      <div className="flex h-7 w-7 items-center justify-center rounded-full bg-brand-gold text-brand-blue-deep">
